...
docker tag bike_share_model_inference gcr.io/snowf-101tot/bike_share_model_inference

docker push gcr.io/snowf-101tot/bike_share_model_inference

gcloud run deploy bikeshare-model-inference --image  gcr.io/snowf-101tot/bike_share_model_inference --region us-central1
